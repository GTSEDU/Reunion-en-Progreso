...
export default function GenerarCompromisoView() {
              ...
              <div className="w-full bg-gray-300 p-6 rounded-lg">
                ...
                <div className="flex items-center justify-center w-full bg-gray-400 p-8 rounded-lg">
                  ...
                  {reuniones.map((reunion, i) => {
                    // Verificamos si todos los integrantes tienen `compromiso` vacío
                    const todosCompromisosVacios = compromisos[i].integrantes.every(integrante => integrante.compromiso === "");

                    // Solo mostramos el CompromisoCard si `todosCompromisosVacios` es true
                    return todosCompromisosVacios && (
                        <CompromisoCard
                            key={i}
                            cardId={reunion.id}
                            title={reunion.title}
